 ...
 * @author user
 */
public class BlockA extends javax.swing.JFrame {
...
private ResultSet displayResult, displayAllResult;
    ...
    //Method to display all the available rooms.
    private void DisplayRooms() {
        
         //Take the method from DatabaseConnection to establish database connection.
        ...
        if (errorDetection == true) {
            ...
            String displayAlLSQL = "SELECT COUNT(Room_ID) AS AllRooms "
                                + "FROM Rooms "
                                + "WHERE User_ID IS NULL AND Room_Block = 'A'";
            ...
            while (displayAllResult.next()){
                ...
                //Display the result into the text field.
    ...
    private void initComponents() {
        ...
        BlockASidePnl = new javax.swing.JPanel();
        BlockALogo = new javax.swing.JLabel();
        LogOutBtn = new javax.swing.JButton();
        BackBtn = new javax.swing.JButton();
        BlockAPnl = new javax.swing.JPanel();
        ...
        BlockASidePnl.setBackground(new java.awt.Color(0, 0, 0));
        BlockASidePnl.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        BlockALogo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/icons8-building-filled-100 (10).png"))); // NOI18N
        BlockASidePnl.add(BlockALogo, new org.netbeans.lib.awtextra.AbsoluteConstraints(58, 281, -1, -1));
        ...
        BlockASidePnl.add(LogOutBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 592, 220, 78));
        ...
        BlockASidePnl.add(BackBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 220, 73));

        getContentPane().add(BlockASidePnl, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 220, 670));

        BlockAPnl.setBackground(new java.awt.Color(255, 255, 255));
        BlockAPnl.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseDragged(java.awt.event.MouseEvent evt) {
                BlockAPnlMouseDragged(evt);
            }
        });
        BlockAPnl.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                BlockAPnlMousePressed(evt);
            }
        });
        BlockAPnl.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());
        ...
        BlockAPnl.add(ExitBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 0, 90, 40));
        ...
        BlockAPnl.add(MinimizeBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 0, 90, 40));

        RoomsLeftSep.setBackground(new java.awt.Color(0, 0, 0));
        RoomsLeftSep.setForeground(new java.awt.Color(0, 0, 0));
        BlockAPnl.add(RoomsLeftSep, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 110, 240, -1));
        ...
        BlockAPnl.add(RoomsLeftLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 80, -1, -1));
        ...
        BlockAPnl.add(RoomsLeftNumberLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 80, 220, 30));
        ...
        BlockAPnl.add(FirstFloorNumberLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(269, 210, 120, -1));

        FirstFloorSep.setBackground(new java.awt.Color(0, 0, 0));
        FirstFloorSep.setForeground(new java.awt.Color(0, 0, 0));
        BlockAPnl.add(FirstFloorSep, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 240, 140, -1));
        ...
        BlockAPnl.add(FirstFloorLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 190, 80, 70));
        ...
        BlockAPnl.add(SixthFloorLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 190, 80, 70));
        ...
        BlockAPnl.add(SixthFloorNumberLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(579, 210, 120, -1));

        SixthFloorSep.setBackground(new java.awt.Color(0, 0, 0));
        SixthFloorSep.setForeground(new java.awt.Color(0, 0, 0));
        BlockAPnl.add(SixthFloorSep, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 240, 140, -1));

        SecondFloorSep.setBackground(new java.awt.Color(0, 0, 0));
        SecondFloorSep.setForeground(new java.awt.Color(0, 0, 0));
        BlockAPnl.add(SecondFloorSep, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 320, 140, -1));
        ...
        BlockAPnl.add(SecondFloorNumberLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(269, 290, 120, -1));
        ...
        BlockAPnl.add(SecondFloorLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 270, 80, 70));

        ThirdFloorSep.setBackground(new java.awt.Color(0, 0, 0));
        ThirdFloorSep.setForeground(new java.awt.Color(0, 0, 0));
        BlockAPnl.add(ThirdFloorSep, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 400, 140, -1));
        ...
        BlockAPnl.add(ThirdFloorNumberLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(269, 370, 120, -1));
        ...
        BlockAPnl.add(ThirdFloorLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 350, 80, 70));

        FourthFloorSep.setBackground(new java.awt.Color(0, 0, 0));
        FourthFloorSep.setForeground(new java.awt.Color(0, 0, 0));
        BlockAPnl.add(FourthFloorSep, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 480, 140, -1));
        ...
        BlockAPnl.add(FourthFloorNumberLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(269, 450, 120, -1));
        ...
        BlockAPnl.add(FourthFloorLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 430, 80, 70));

        FifthFloorSep.setBackground(new java.awt.Color(0, 0, 0));
        FifthFloorSep.setForeground(new java.awt.Color(0, 0, 0));
        BlockAPnl.add(FifthFloorSep, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 560, 140, -1));
        ...
        BlockAPnl.add(FifthFloorNumberLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(269, 530, 120, -1));
        ...
        BlockAPnl.add(FifthFloorLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 510, 80, 70));
        ...
        BlockAPnl.add(SeventhFloorLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 270, 80, 70));
        ...
        BlockAPnl.add(EighthFloorLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 350, 80, 70));
        ...
        BlockAPnl.add(NinthFloorLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 430, 80, 70));
        ...
        BlockAPnl.add(TenthFloor, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 510, 80, 70));

        TenthFloorSep.setBackground(new java.awt.Color(0, 0, 0));
        TenthFloorSep.setForeground(new java.awt.Color(0, 0, 0));
        BlockAPnl.add(TenthFloorSep, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 560, 140, -1));
        ...
        BlockAPnl.add(TenthFloorNumberLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(579, 530, 120, -1));

        NinthFloorSep.setBackground(new java.awt.Color(0, 0, 0));
        NinthFloorSep.setForeground(new java.awt.Color(0, 0, 0));
        BlockAPnl.add(NinthFloorSep, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 480, 140, -1));
        ...
        BlockAPnl.add(NinthFloorNumberLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(579, 450, 120, -1));

        EightFloorSep.setBackground(new java.awt.Color(0, 0, 0));
        EightFloorSep.setForeground(new java.awt.Color(0, 0, 0));
        BlockAPnl.add(EightFloorSep, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 400, 140, -1));
        ...
        BlockAPnl.add(EighthFloorNumberLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(579, 370, 120, -1));

        SeventhFloorSep.setBackground(new java.awt.Color(0, 0, 0));
        SeventhFloorSep.setForeground(new java.awt.Color(0, 0, 0));
        BlockAPnl.add(SeventhFloorSep, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 320, 140, -1));
        ...
        BlockAPnl.add(SeventhFloorNumberLab, new org.netbeans.lib.awtextra.AbsoluteConstraints(579, 290, 120, -1));

        getContentPane().add(BlockAPnl, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 0, 850, 670));
    ...
    private void MinimizeBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MinimizeBtnActionPerformed
        ...
        this.setState(BlockA.ICONIFIED);
    }//GEN-LAST:event_MinimizeBtnActionPerformed

    private void BlockAPnlMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BlockAPnlMousePressed
        // TODO add your handling code here:

        
    }//GEN-LAST:event_BlockAPnlMousePressed

    private void BlockAPnlMouseDragged(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BlockAPnlMouseDragged
        // TODO add your handling code here:
        
    }//GEN-LAST:event_BlockAPnlMouseDragged
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BlockA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new BlockA().setVisible(true);
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JButton BackBtn;
    private javax.swing.JLabel BlockALogo;
    private javax.swing.JPanel BlockAPnl;
    private javax.swing.JPanel BlockASidePnl;
